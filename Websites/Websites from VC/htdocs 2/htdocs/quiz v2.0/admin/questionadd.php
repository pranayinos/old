...
$qry3="SELECT * from mst_question WHERE test_id=$testid and level=$level";
...
if($t_no_of_ques > $c_no_of_ques)
{
	if($l_no_of_ques < 3)
	{
		mysql_query("insert into mst_question(test_id,que_desc,ans1,ans2,ans3,ans4,true_ans,level) values ('$testid','$addque','$ans1','$ans2','$ans3','$ans4','$anstrue', '$level')",$cn) or die(mysql_error());
