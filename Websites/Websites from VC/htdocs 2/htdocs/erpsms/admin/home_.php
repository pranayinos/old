  ...
  <div class="button-box"> <a href="?page=student" class="option_buttons" id="student_details_button" nicetitle="Search for existing and former students.">
    ...
    <div class="button-box">
      <a href="?page=configuration" class="option_buttons" id="settings_button" nicetitle="Configure the basic school settings"><div class="button-label"><p>Settings</p></div>
       ...
       <div class="button-box">
        <a href="?page=employee/hr" class="option_buttons" id="hr_button" nicetitle="        Human Resource Department"><div class="button-label"><p>Human Resources</p></div>
        </a>
      </div>
      ...
      <div class="button-box">
        ...
        <div class="button-box">
          <a href="?page=hostel_dashboard" class="option_buttons" id="hostel_button" nicetitle="Manage Hostel"><div class="button-label"><p>Hostel</p></div>
          </a>
        </div>
        ...
        <div class="button-box">
          <a href="?page=transport/dash_board" class="option_buttons" id="transport_button" nicetitle="Manage Transport"><div class="button-label"><p>Transport</p></div>
          </a>
        </div>
