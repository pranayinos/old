...
$admno = $student->getdata('MAX(stud_id) AS rollno',"stud_registration","","","");// select Addmission  no
...
/**** select student roll prefix ********/
    ...
    {
      // batch entry 
			   $cols['std_reg_no'] =$_POST['std_adm_no'];
   ...
   if($student->Inserttable($cols,"stud_registration"))
        {
				$msg="Student Registration Added Succesfully";
				//header("location:?page=admission&msg=$msg");	
				header("location:?page=student_registration&msg=$msg");			
		}
		else
		{
			$msg="Error :  Entry not done, Please check Values";
			header("location:?page=student_registration&error=$msg");
		}		
...
<div id="inner-tab-menu">
  <ul>
    <li><a href="?page=student_registration_view_all">View all</a></li>
...
<?php /*?><div class="msg" ><?php echo $_GET[msg]?></div>
 <div class="error" ><?php echo $_GET[error]?></div><?php */?>
      ...
      <div id="autofill-area">
        ...
        <div class="student_admission_date">
          ...
          <div class="text-input-bg-admission">
              ...
              <input id="std_adm_no"  name="std_adm_no" size="30" type="text" value="RG-<?=$roll?>">
        ...
        <div class="student_admission_date">
          ...
          <div class="text-input-bg-admission">
                    <input id="std_adm_date" name="std_adm_date" type="text" value=""> <img alt="Calendar" class="calendar_date_select_popup_icon" onClick="new CalendarDateSelect( $(this).previous(), {year_range:[1997, 2017]} );" src="./css/calendar.gif" style="border:0px; cursor:pointer;">
          </div>
        </div>
...
<?php }?>
        ...
        <div class="label-field-pair">
          ...
          <div class="text-input-bg">
            <input id="std_dob" name="std_dob" type="text" value=""> <img alt="Calendar" class="calendar_date_select_popup_icon" onClick="new CalendarDateSelect( $(this).previous(), {year_range:[1972, 2012]} );" src="css/calendar.gif" style="border:0px; cursor:pointer;">
          </div>
        </div>
...
-->
<option value="Indian" selected="selected">India</option>
...
<option value="195">Zimbabwe</option>--></select> </div>
      ...
      <input class="submit_button" name="addNew_bt" type="submit" title="submit form" value="► Save"/>
 </form>
