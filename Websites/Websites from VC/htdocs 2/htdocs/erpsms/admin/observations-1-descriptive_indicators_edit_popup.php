...
<div id="grading-levels-form">
 ...
 <form action="#" class="edit_descriptive_indicator" id="edit_descriptive_indicator_1" method="post" onsubmit="new Ajax.Request(&#39;/observations/1/descriptive_indicators/1&#39;, {asynchronous:true, evalScripts:true, parameters:Form.serialize(this)}); return false;"><div style="margin:0;padding:0;display:inline"><input name="_method" type="hidden" value="put"><input name="authenticity_token" type="hidden" value="ioHd1weWldQoLIQ81Y+dwML4e/LqwAF6IihFNU0ZREI="></div>
      <div id="form-errors"></div>
      
      <div class="label-field-pair">
        <label for="category_name">Name</label>
        <div class="text-input-bg"><input id="descriptive_indicator_name" name="descriptive_indicator[name]" size="30" type="text" value="Indicator" class="MB_focusable"></div>
      </div>
      <div class="label-field-pair">
