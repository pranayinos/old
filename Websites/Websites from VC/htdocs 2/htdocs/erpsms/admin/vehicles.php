...
<div id="inner-tab-menu">
  <ul>
    <li><a href="?page=vehicles-new">Add Vehicle</a></li>
  </ul>
</div>
<div id="page-yield">
  ...
  <table align="center" width="100%" cellpadding="1" cellspacing="1" id="listing">
    <tbody><tr class="tr-head"><td>Vehicle Number</td>  <td>Route</td>  <td>No of seats</td>  <td>Status</td>  <td></td> </tr>
      ...
      <tr class="tr-odd">
        ...
        <td class="col-4"> Active</td>

        <td class="col-5"><a href="?page=vehicles-1-edit">Edit</a>
