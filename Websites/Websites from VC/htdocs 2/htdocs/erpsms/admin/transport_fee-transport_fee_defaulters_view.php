...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <title><? echo $page_title ." | ". SITENAME ?></title>
  ...
  <img alt="Transport_small" src="./transport_fee-transport_fee_defaulters_view_files/transport_small.png">
  <h1>Transport Fee</h1>
  <h3>Student Defaulters</h3>
  <div id="app-back-button">
    <a href="http://demo.fedena.org/transport_fee/transport_fee_defaulters_view#" onclick="history.back(); return false;"><img alt="Back" border="0" src="./transport_fee-transport_fee_defaulters_view_files/back.png"></a>
  </div>
</div>
<div id="inner-tab-menu">
  <ul>
    <li><a href="http://demo.fedena.org/transport_fee/employee_defaulters_transport_fee_collection">Employee Defaulters</a></li>
