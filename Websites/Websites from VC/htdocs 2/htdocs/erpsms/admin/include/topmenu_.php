...
<ul id="main-menu">
  <li class="a"><a href="?page=home" class="border">Dashboard ▼</a>
   <ul class="level-1">
    ...
    <li class="a"><a href="?page=student" class="border">Students ▼</a>
   <ul class="level-1">
    ...
    <li class="a"><a href="?page=attendance_reports" class="border">Timetable <span class="down-arrow">▼</span></a>
      <ul class="level-1">
            <li><a href="?page=attendance_reports">Create/Edit Timetable</a></li>
          <li><a href="?page=attendance_reports">Set class timings</a></li>
          <li><a href="?page=attendance_reports">View Timetables</a></li>
            <li><a href="?page=attendance_reports">Swap class</a></li>
        <li><a href="timetable/timetable">Institutional Timetable</a></li>
          <li><a href="?page=weekday">Create weekdays</a></li>
      </ul>
    </li>
  <li class="a"><a href="?page=more" class="border">More ▼</a>
    <ul class="level-1">
      <li><a href="?page=calendar">Calendar</a></li>
        ...
        <li><a href="?page=exam">Examination <span class="right-arrow">▶</span></a>
          <ul class="level-2">
              ...
              <li><a href="?page=create_exam">Exam Management</a>  </li>
              <li><a href="?page=create_additional_exam">Additional Exams</a></li>
            <li><a href="?page=exam_wise_report">Exam Wise Report</a></li>
            <li><a href="?page=subject_wise_report">Subject wise Report</a> </li>
            <li><a href="?page=grouped_exam_report">Grouped exam Reports</a></li>
                <li><a href="?page=online_exam">Online Exam</a></li>            
          </ul>
        </li>      
      <li><a href="?page=news">News</a></li>
        ...
        <li><a href="?page=hr">Human Resource <span class="right-arrow">▶</span></a>
          <ul class="level-2">
              ...
              <li><a href="?page=employee_management">Employee Management</a></li>
              <li><a href="?page=employee_attendance">Employee Leave Management</a></li> 
              <li><a href="?page=payslip">Create Payslip</a></li>
              <li><a href="?page=search">Employee Search</a></li>  
              <li><a href="?page=department_payslip">Employee payslip</a></li> </ul>
        </li>    
      
        <li><a href="?page=finance">Finance <span class="right-arrow">▶</span></a>
          <ul class="level-2">
            <li><a href="?page=fees_home">Fees</a> </li>
            <li><a href="?page=categories">Category</a> </li>
        ...
        <li><a href="?page=user">User</a></li>
            <li><a href="?page=online_meeting_rooms">Collaborate</a>              
            </li>
            <li><a href="?page=index">Discussion</a>              
            </li>
            <li><a href="?page=galleries">Gallery</a>              
            </li>
            <li><a href="?page=hostel_dashboard">Hostel <span class="right-arrow">▶</span></a>              
                <ul class="level-2">                  
                    ...
                    <li><a href="?page=hostel_fee_pay">Pay student hostel fee</a></li>                  
                </ul>              
            </li>
            <li><a href="?page=library">Library <span class="right-arrow">▶</span></a>              
                <ul class="level-2">                  
                    ...
                    <li><a href="?page=return_book">Return book</a></li>                  
                    <li><a href="?page=direct_issue_book">Issue books</a></li>                  
                    <li><a href="?page=card_setting">Library setting</a></li>                  
                    <li><a href="?page=movement_log">Movement Log</a></li>                  
                    <li><a href="?page=renewal">Book renewal</a></li>                  
                </ul>              
            </li>
            ...
            <li><a href="?page=dash_board">Transport <span class="right-arrow">▶</span></a>
  ...
  <li class="a"><a href="?page=configuration" class="border">Settings ▼</a>
      <ul class="level-1">        
          ...
          <li><a href="?page=general-settings">General Settings</a></li>
