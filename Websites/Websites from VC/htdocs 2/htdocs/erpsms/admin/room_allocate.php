...
xmlhttp.open("GET","?page=user_view_div&q1="+str,true);
xmlhttp.send();
}
</script>
...
<div id="content-header">
  ...
  <h1>Hostel</h1>
  <h3>Search student for room allocation</h3>
  <div id="app-back-button">
    <a href="http://demo.fedena.org/room_allocate#" onClick="history.back(); return false;"><img alt="Back" border="0" src="../images/buttons/back.png"></a>
  </div>
</div>
