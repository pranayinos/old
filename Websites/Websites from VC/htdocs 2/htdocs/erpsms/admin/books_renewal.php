...
$id1=$_GET[id1];
$newsRecord = $issue_books->getdata('*',"issue_books","issue_book_id='$id1'","", "");
...
if(isset($_POST['commit'])) // If the submit button was clicked
    {
				...
				if($issue_books->updateData($post,"issue_books","issue_book_id='$id1'"))
				{
						$msg="Issue Book Record Updated Succesfully";
 ...
 <div class="error" ><?php echo $_GET[error]?></div>
      ...
      <div id="user">
        <div class="label-field-pair">
          ...
          <div class="text-input-bg">
             <input disabled="disabled" id="name" name="name" size="30" type="text" value="<?=$record['name'];?>">
            <input  id="library_name" name="name" size="30" type="hidden" value="<?=$record['name'];?>"class="validate[required]  text-input">
        ...
        <div class="label-field-pair">
          ...
          <div class="text-input-bg">
              <input disabled="disabled" id="std_adm_no" name="std_adm_no" size="30" type="text" value="<?=$record['std_adm_no'];?>">
            <input  id="library_username" name="std_adm_no" size="30" type="hidden" value="<?=$record['std_adm_no'];?>" class="validate[required]  text-input">
          </div>
        </div>
