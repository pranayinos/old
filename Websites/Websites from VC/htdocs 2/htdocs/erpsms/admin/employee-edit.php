...
$cat_id=$_GET[id];						 
$newsRecordSet = $emp->getdata('*',"emp","emp_no='$cat_id'","emp_no DESC", "50");
 ...
 if(isset($_POST['btsubmit'])) // If the submit button was clicked
    {
      // manage course update 
		     ...
		     $post['category_description'] =$_POST['category_description'];
			   ...
			   if($emp_no->updateData($post,"emp","emp_no='$cat_id'"))
				 {
				 $msg="News updated Succesfully";
				 header("location:?page=employee_edit&cat_id=$cat_id&msg=$msg");			
				}
				else
				{
					$msg="Error :  Entry not done, Please check Values";
					header("location:?page=employee_edit&id=$cat_id&error=$msg");
				}		
	}
    ...
    <!--  <div id="necessary-field-notification"> Fields marked with  <span class="necessary-field">*</span>must be filled.</div>-->
     <!-- <span class="span-sub-heading">General Details</span>-->
      ...
      <div class="label-field-pair">
        ...
        <div class="text-input-bg"><input id="employee_employee_number" name="employee[employee_number]" size="30" type="text" value="<?=$record['emp_no']?>"></div>
      </div>
