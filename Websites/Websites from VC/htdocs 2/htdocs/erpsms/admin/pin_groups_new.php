...
<div id="page-yield">
  ...
  <div id="applicant_form">
    <form action="http://demo.fedena.org/pin_groups" class="new_pin_group" id="new_pin_group" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="kCWJmowIJe0ctFJ3Do7/FinMssy2Iox1bXH7//ekfPM="></div>
      ...
      <div class="label-field-pair">
        ...
        <input id="pin_group_name" name="pin_group[name]" size="30" type="text">
      </div>
      <div class="label-field-pair">
        <label for="pin_group_pin_count">Pin count</label>
        <input id="pin_group_pin_count" name="pin_group[pin_count]" size="30" type="text">
      </div>
      <div class="label-field-pair">
