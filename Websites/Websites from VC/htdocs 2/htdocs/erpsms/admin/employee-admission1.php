...
if ( ($rollrow = $admno->getNextRecord()) !== false )
 	$roll=$rollrow['employee_employee_number'];
...
//INSERT CODE IMPLEMENT 
 	...
 	if(isset($_POST['commit'])) // If the submit button was clicked
      ...
      // employee admission 5 OCT 2012
			   ...
			   $cols['emp_total_exp_yr'] =$_POST['employee_experience_year'];
			  ...
			  // $cols['emp_spouse_name'] =$_POST['emp_spouse_name'];
			   ...
			   $cols['file'] =$_POST['file'];
			  
			  
	  // INSERT THE CODE OF IMAGE UPLOADING 
...
{
	 $change='<div class="msgdiv"></div> ';
	$errors=1;
	header("location:postadd.php?msg=You have exceeded the size limit!");
}
else
{
...
$cat=$_POST[cat];
$img=$_POST[img];
#echo $sql="insert into firstadv_image (img_big,img_small) values('$filename','$filename1')";
/*$sql="insert into firsrtadv_image (img,image_type,adv_link) values('$filename','1','$txtlink')";
$qry=mysql_query($sql);*/
#echo "success";
$cols['file'] =$image;
...
imagedestroy($tmp);
imagedestroy($tmp1);
	//header("location:postadd.php?action=1&title=$title&msg=Submitted the Data ");
}
}
}
}
   ...
   // mysql_query("update {$prefix}users set img='$big',img_small='$small' where user_id='$user'");
	...
	else
	{
	   if($emp->Inserttable($cols,"emp"))
        {
				//$msg="New Student Added Succesfully";
			//header("location:?page=add_guardian");			
		}
		else
		{
			//$msg="Error :  Entry not done, Please check Values";
...
<div id="page-yield">
  ...
  <form id="formID" name="formID" action="" enctype="multipart/form-data" method="post"><div style="margin:0;padding:0;display:inline">
    ...
    <div id="admission1_form">
      ...
      <div class="label-field-pair">
        ...
        <div class="text-input-bg">
          <?php $rollprefix="E" ?><?PHP $a=1;?>
            <input id="employee_employee_number" name="employee_employee_number" size="30" type="text" value="<?=$rollprefix.($roll+$a)?>" readonly="readonly">
          </div>
      </div>
      ...
      <div class="label-field-pair">
        ...
        <div class="text-input-bg"><input id="employee_joining_date" name="employee_joining_date"  type="text" class="validate[required]  text-input"> <img alt="Calendar" class="calendar_date_select_popup_icon" onClick="new CalendarDateSelect( $(this).previous(), {popup:&#39;force&#39;, year_range:[1987, 2012]} );" src="../images/calendar_date_select/calendar.gif" style="border:0px; cursor:pointer;"></div>
      </div>
       <!-- <hr class="label-underline">-->
     <div class="label-field-pair">
        <label for="employee_name">First Name<span class="necessary-field">*</span> </label>
        <div class="text-input-bg"><input id="employee_first_name" name="employee_first_name" size="30" type="text" class="validate[required]  text-input"></div>
      </div>
         <!-- <hr class="label-underline">-->
       <div class="label-field-pair">
       ...
       <div class="label-field-pair">
        ...
        <div class="text-input-bg"><input id="employee_last_name" name="employee_last_name" size="30" type="text" class="validate[required]  text-input"></div>
      </div>
         <!-- <hr class="label-underline">-->
       <div class="label-field-pair">
        <label>Email</label>
        <div class="text-input-bg"><input id="employee_email" name="employee_email" size="30" type="text" class="validate[required,custom[email]] text-input"></div>
       ...
       <div class="label_field_pair">
        ...
        <div class="employee_gender_value">
          ...
          <input id="employee_gender" name="employee_gender" type="radio" value="1" class="validate[required] radio">
		  <label class="label_for_gender" for="master_student_gender_false">Female</label>
          <input id="employee_gender" name="employee_gender" type="radio" value="0" class="validate[required] radio">
        </div>
      </div>
         <!-- <hr class="label-underline">-->
       <div class="label-field-pair">
        <label for="dob">Date of Birth<span class="necessary-field">*</span></label>
        <div class="text-input-bg"><input id="employee_date_of_birth" name="employee_date_of_birth"  type="text" value="" class="validate[required]  text-input"> <img alt="Calendar" class="calendar_date_select_popup_icon" onClick="new CalendarDateSelect( $(this).previous(), {popup:&#39;force&#39;, year_range:[1947, 2012]} );" src="../images/calendar_date_select/calendar.gif" style="border:0px; cursor:pointer;"></div>
      </div>
       <!--  <!-- <hr class="label-underline">-->
       <div class="label-field-pair">
        <label for="employee_department">Department <span class="necessary-field">*</span></label>
        <div class="text-input-bg"><select id="employee_employee_department_id" name="employee_employee_department_id" class="validate[required]  text-input">
...
<option value="<?=$record['emp_posn']?>"><?=$record['emp_posn']?> </option>
<?php }?>
            </select>
</div></div>
      </div>
...
<option value="<?=$record['grade_name']?>"><?=$record['grade_name']?> </option>
<?php }?>
</select></div>
      </div>
       <!-- <hr class="label-underline">-->
...
<option value="11">11</option></select></div>
       ...
       <div class="label_field_pair">
        ...
        <input id="employee_status" name="employee_status" type="radio" value="true" class="validate[required] radio">

        <label class="label_for_status" for="employee_status_false">Inactive</label>
        <input id="employee_status" name="employee_status" type="radio" value="false" class="validate[required] radio">
...
<option value="195">Zimbabwe</option>--></select></div>
      ...
      <div class="label-field-pair">
        <label for="master_student_image_file">Upload User Photo (10KB max)</label>
        <div class="text-input-bg"><input id="file" name="file" size="12" type="file"></div>
