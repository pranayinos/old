...
<link href="css/emp_exam_wise_report.css" media="screen" rel="stylesheet" type="text/css">
 <!--------- Start head ---------------->
  </head>
  <body>
...
<div id="page-yield">
 ...
 <div class="box">
<form action="#" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="RM7M/dfBSggxM94jqOhrG+EJA2+KE+zai4pQ3dXps/c="></div>

<div class="text-input-bg">
<select id="exam_report_batch_id" name="exam_report[batch_id]" onchange="Element.show(&#39;loader&#39;); new Ajax.Request(&#39;/exam/list_exam_types&#39;, {asynchronous:true, evalScripts:true, onSuccess:function(request){Element.hide(&#39;loader&#39;)}, parameters:&#39;batch_id=&#39;+value + &#39;&amp;authenticity_token=&#39; + encodeURIComponent(&#39;RM7M/dfBSggxM94jqOhrG+EJA2+KE+zai4pQ3dXps/c=&#39;)})"><option value="">Select a Batch</option>
