...
<link href="css/emp_advanced_search.css" media="screen" rel="stylesheet" type="text/css">
 <!--------- Start head ---------------->
  </head>
  <body>
...
<option value="6">E</option></select>
        </div>
      </div>
...
<option value="greater_than">greater than</option></select>
      ...
      <div class="label-field-pair">
        <label for="student_admission_no">Date of Birth
          <img align="absmiddle" alt="Loader" border="0" id="loader" src="./emp_employee-advanced_search_files/loader.gif" style="display: none;">
        </label>
        <div class="text-input-bg">
          <select id="adv_search_dob_option" name="adv_search[dob_option]" onchange="Element.show(&#39;loader&#39;); new Ajax.Request(&#39;/employee/list_dob_year&#39;, {asynchronous:true, evalScripts:true, onSuccess:function(request){Element.hide(&#39;loader&#39;)}, parameters:&#39;dob_option=&#39;+value + &#39;&amp;authenticity_token=&#39; + encodeURIComponent(&#39;HLXw9pp1LGHXQIbHeJV5buYl4nvs9klhjKVT3A7ipVA=&#39;)})"><option value="">choose your option</option>
<option value="equal_to">equal to</option>
<option value="less_than">less than</option>
<option value="greater_than">greater than</option></select>
          <div id="dob_year">
