...
<div id="content-header">
  ...
  <div id="app-back-button">
    <a href="http://demo.fedena.org/student_attendance#" onClick="history.back(); return false;"><img alt="Back" border="0" src="../images/buttons/back.png"></a>
  </div>
</div>
...
<div id="page-yield">
  ...
  <div id="box">
        ...
        <div class="link-box">
          <div class="link-heading"><a href="?page=emp_register">Attendance register</a></div>
        ...
        <div class="link-box">
          <div class="link-heading"><a href="?page=emp_attendance_reports">Attendance Report</a></div>
