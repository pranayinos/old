...
session_start();	
 ...
 $session_studentuser=$_SESSION['session_studentuser'];
$vcadminuser= $_COOKIE["vcstudentuser"];
  if($session_studentuser=="" )
  {
  ...
  $userRecordSet = $pageobj->getdata('*',"user","user_id='$session_studentuser'","", "");
