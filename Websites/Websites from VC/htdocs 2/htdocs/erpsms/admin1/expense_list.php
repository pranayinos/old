<?php
    $expense = new Main(); // create a new news object
...
<div id="page-yield">
  <div>
    ...
    <form action="?page=expense_list" method="post">
...
<div>
   ...
   $start_date=date("d-m-Y", strtotime($_POST[start_date]));
    $end_date=date("d-m-Y", strtotime($_POST[end_date]));
 	$newsRecordSet = $expense->getdata('*',"fin_transaction,finance_category","finance_category.income='0' and finance_category. finance_id=fin_transaction.tr_category","fin_transaction.tr_date DESC", "");// set newsRecordSet to a 
