...
<link href="css/generate_previous_reports.css" media="screen" rel="stylesheet" type="text/css">
...
<img alt="Show_exam" src="../images/examination/show_exam.png">
  <h1>Exams</h1>
  <h3>Generate Previous Batch Reports</h3>
    ...
    <form action="#" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="Fx0ICRRbO4rrhCDJM/624/7sUzivQNmpkyG0E+3MKOA="></div>
      <div class="label-field-pair">
        ...
        <div class="text-input-bg">
          <select id="report_course_id" name="report[course_id]" onChange="new Ajax.Request(&#39;/exam/select_inactive_batches&#39;, {asynchronous:true, evalScripts:true, parameters:&#39;course_id=&#39;+value + &#39;&amp;authenticity_token=&#39; + encodeURIComponent(&#39;Fx0ICRRbO4rrhCDJM/624/7sUzivQNmpkyG0E+3MKOA=&#39;)})"><option value="">Select a course</option>
...
<option value="41">Standard 3 </option></select></div></div>
        <div id="select_inactive_batches"><p class="flash-msg"><span class="translation_missing">en, flash12</span></p></div>
