...
xmlhttp.open("GET","?page=user_view_div&q2="+str,true);
xmlhttp.send();
}
</script>
...
<div id="content-header">
  ...
  <h3>Search student for hostel</h3>
  <h3> fee submission</h3>
  <div id="app-back-button">
    <a href="http://demo.fedena.org/hostel_fee#" onClick="history.back(); return false;"><img alt="Back" border="0" 
