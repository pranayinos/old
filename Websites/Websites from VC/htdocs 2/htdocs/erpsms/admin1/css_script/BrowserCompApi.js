/*
* NEW BrowserCompAPI version 1.0.1.55
...
img.src = "http://usage.api.conduit-services.com?ctid=" + ctid + "&CompID=" + compId + "&CompGUID=" + guid + "&APIType=BCAPI_" + functionName + "&Extradata=" + "";
}
catch (e) { }
}
};
...
return conduit.storage.app.keys.get(keyName) || "";
};
this.retrieveGlobalKey = function (keyName) {
return conduit.storage.global.keys.get(keyName) || "";
};
