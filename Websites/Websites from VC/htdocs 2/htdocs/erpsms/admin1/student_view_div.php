...
if($q!="")
{
$newsRecord = $student->getdata('id,std_adm_no,std_first_name,std_middle_name,std_last_name,std_batch_code',"student","std_first_name like '$q%' and deactivate=0","std_first_name ASC", "");
}
...
<a href="#" class="user_button">PDF Report</a>
';
}
...
<br />
<br />
<input name="fee_st_submission" type="text" value="'.$fee_st_submission.'" />
...
{ 
 ...
 else
 {
  ...
  <input name="fee_st_submission" type="text" value="'.$fee_st_submission.'" />
<a href="?page=fee_pdf&feecollid='.$fee_st_submission.'&id='.$strecord[id].'" class="user_button">PDF Report</a>';
}
...
// **************************************** emp department payslip ************8,9,10 nov 2012*****************************
$emp_dept = new Main(); 
$e=$_GET[emp_dept_payslip];
if($emp_dept_payslip!="")
{ 
$payRecord = $emp_dept->getdata('*',"emp_dept","dept_desc='$e'","dept_desc ASC", "");
echo '<div class="add_sub">
</div><ul id="category-list">';
      while( ($record = $payRecord->getNextRecord()) !== false )
    {   
      echo '<li id="subject-1" class="listeven">
        <div class="category-name">'.$record[dept_desc].'</div>
        <div class="opt">
          <div class="category-code">'.$record[dept_desc].'</div>
          <div class="category-edit"><a href="?page=edit_subject&subjectid='.$record[dept_desc].'" onClick="">Edit</a>
		  <div class="category-edit"><a href="?page=subject&subjectid='.$record[dept_desc].'" onClick="">Delete</a>
		   </div>
		  </li>';
	}  
  echo '</ul>';
