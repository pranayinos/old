...
<!-- End the msg code --------------------------------------->
  ...
  <form name="formID" id="formID" action="#" method="post"><div style="margin: 0px; padding: 0px; display: inline;"><input name="authenticity_token" type="hidden" value=""></div>
...
?>
      ...
      <div class="label-field-pair">
        ...
        <div class="text-input-bg"><input id="student_previous_details_institution" name="student_previous_details_institution" size="30" type="text" class="validate[required]  text-input"></div>
        <div class="extender"></div>
      </div>
      <div class="label-field-pair">
        <label>Course</label>
        <div class="text-input-bg"><input id="student_previous_details_course" name="student_previous_details_course" size="30" type="text" class="validate[required]  text-input"></div>
        <div class="extender"></div>
      </div>
      <div class="label-field-pair">
        <label>Year</label>
        <div class="text-input-bg"><input id="student_previous_details_year" name="student_previous_details_year" size="30" type="text" class="validate[required]  text-input"></div>
        <div class="extender"></div>
      </div>
      <div class="label-field-pair">
        <label>Total mark</label>
        <div class="text-input-bg"><input id="student_previous_details_total_mark" name="student_previous_details_total_mark" size="30" type="text" class="validate[required]  text-input"></div>
        <div class="extender"></div>
      </div>
