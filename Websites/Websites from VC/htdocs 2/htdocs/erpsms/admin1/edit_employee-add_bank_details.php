...
$emp_bank = new Main(); 
$bank_id=$_GET[emp_payroll_id];
$newsRecordSet = $emp_bank->getdata('*',"emp_bank","emp_bank_id=$bank_id","emp_bank_id DESC", "50");  
...
//Update code run 
 if(isset($_POST['commit'])) // If the submit button was clicked
    { 
 	 		   $emp_cat_id=$_POST['bank_id'];
			   $post['emp_bank_name'] =$_POST['bank_field_name'];
			   $post['emp_bank_status'] =$_POST['bank_field_status'];
			  
			  
			   if($emp_bank->updateData($post,"emp_bank","emp_bank_id='$bank_id'"))
				   {
...
<form id="formID" name="formID" action="#" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value=""></div>
      ...
      <div id="form-content">
        <div class="label-field-pair">
          ...
          <div class="text-input-bg"> <input id="bank_field_name" name="bank_field_name" size="30" class="validate[required]  text-input" type="text" value="<?=$record['emp_bank_name']?>"> </div>
        </div>
