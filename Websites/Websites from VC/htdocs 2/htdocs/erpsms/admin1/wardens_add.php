...
<link href="css/#.css" media="screen" rel="stylesheet" type="text/css">
 <!--------- Start head ---------------->
  ...
  <img alt="Hostel_small" src="./wardens_add_files/hostel_small.png">
  <h1>Hostel</h1>
  <h3>Manage Wardens</h3>
  <div id="app-back-button">
    <a href="#" onClick="history.back(); return false;"><img alt="Back" border="0" src="./wardens_add_files/back.png"></a>
  </div>
</div>
<div id="inner-tab-menu">
  <ul>
    <li><a href="#">Add Warden</a></li>
  </ul>
</div>
<div id="page-yield">
