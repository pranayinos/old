...
<div id="grading-levels-form">
 ...
 <form action="#" class="new_descriptive_indicator" id="new_descriptive_indicator" method="post" onsubmit="new Ajax.Request(&#39;/observations/1/descriptive_indicators&#39;, {asynchronous:true, evalScripts:true, parameters:Form.serialize(this)}); return false;"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="ioHd1weWldQoLIQ81Y+dwML4e/LqwAF6IihFNU0ZREI="></div>
      <div id="form-errors"></div>
      
      <div class="label-field-pair">
        <label for="category_name">Name</label>
        <div class="text-input-bg"><input id="descriptive_indicator_name" name="descriptive_indicator[name]" size="30" type="text" class="MB_focusable"></div>
      </div>
      <div class="label-field-pair">
        <label for="category_name">Description</label>
        <div class="text-input-bg"><input id="descriptive_indicator_desc" name="descriptive_indicator[desc]" size="30" type="text" class="MB_focusable"></div>
      </div>
