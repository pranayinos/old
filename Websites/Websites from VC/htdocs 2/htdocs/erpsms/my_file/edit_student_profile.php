...
//29 aug implemented code edit 
$id=$_GET[id];						 
$newsRecordSet1 = $student->getdata('*',"student","id='$id'","id DESC", "");
...
<div id="page-yield">
    <?php  while( ($record = $newsRecordSet1->getNextRecord()) !== false )
    { 
   ?> 

 <form id="#" name="#"  action="#" class="" enctype="multipart/form-data"  method="post">
 ...
 <div class="error" ><?php echo $_GET[error]?></div>
      ...
      <div id="autofill-area">
        ...
        <div class="student_admission_date">
          ...
          <div class="text-input-bg-admission">
                    <input id="std_adm_date" name="std_adm_date" type="text" value="June  2, 2012" disabled="disabled"> <img alt="Calendar" class="calendar_date_select_popup_icon" onClick="new CalendarDateSelect( $(this).previous(), {year_range:[1997, 2017]} );" src="./css/calendar.gif" style="border:0px; cursor:pointer;">
          </div>
        </div>
  ...
  <input id="student_first_name" class="validate[required]  text-input" name="std_first_name"  size="30" type="text" title=""
   value="<?=$record['std_first_name']?>"/>
      ...
      <div class="label-field-pair">
        ...
        <div class="text-input-bg"><input id="student_last_name" class="validate[required]  text-input" name="std_last_name" size="30" type="text" title="" value="<?=$record['std_last_name']?>">
        </div>
      </div>
...
<?php }?>
        ...
        <div class="label_field_pair">
          ...
          <div class="student_gender_value">
            ...
            <input checked="checked" id="student_gender_m" name="std_gender" type="radio" value="MALE">
     ...
     <span class="span-sub-heading">CONTACT Details</span>
      <hr class="sub-heading">
        ...
        <div class="label-field-pair">
          ...
          <div class="text-input-bg"><input id="student_address_line1" name="std_add_1" size="30" type="text"  value="<?=$record['std_add_1']?>"></div>
        </div>
        <div class="label-field-pair">
        ...
        <div class="label-field-pair">
         ...
         <div class="text-input-bg"><input id="student_city" name="std_city" size="30" type="text" title="city where you live"  value="<?=$record['std_city']?>">
          <label id="err6"></label></div>
        </div>
        <div class="label-field-pair">
          <label for="student_state">State</label>
         <div class="text-input-bg"><input id="student_state" name="std_state" size="30" type="text" title="State where you live"  value="<?=$record['std_state']?>"></div>
        </div>
        <div class="label-field-pair">
        <label for="student_pin_code">PIN code</label>
       <div class="text-input-bg"><input id="student_pin_code" name="std_pin" size="30" type="text" title="Pin code of your city"  value="<?=$record['std_pin']?>"></div>
        </div>
        <div class="label-field-pair">
          <label for="student_country">Country</label>
          <div class="text-input-bg"> <select id="student_country_id" name="std_country" disabled="disabled">
          <!--<option value="1">Afghanistan</option>
<option value="2">Albania</option>
<option value="3">Algeria</option>
<option value="4">Andorra</option>
...
<option value="195">Zimbabwe</option>--></select> </div>
        ...
        <div class="label-field-pair">
          ...
          <div class="text-input-bg"><input id="student_phone1" name="std_phone" size="30" type="text" title="" value="<?=$record['std_phone']?>"></div>
        </div>
        <div class="label-field-pair">
          <label for="student_phone2">Mobile</label>
          <div class="text-input-bg"><input id="student_phone2" name="std_mobile" size="30" type="text"  value="<?=$record['std_mobile']?>"></div>
        </div>
        <div class="label-field-pair">
       
          <label for="student_email">Email</label>
          <div class="text-input-bg"><input id="student_email" name="std_email" size="30" type="text" title=""  value="<?=$record['std_email']?>">
          </div>
        </div>
