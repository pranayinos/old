...
<div id="page-yield">
 ...
 <form id="formID" name="formID"  action="#" class="new_student" enctype="multipart/form-data"  method="post">
...
<?php }?>
        ...
        <div class="label-field-pair">
          ...
          <div class="text-input-bg"><input id="std_birth_place" name="std_birth_place" size="30" type="text"></div>
        </div>
...
<option value="195">Zimbabwe</option>--></select>
        ...
        <div class="label-field-pair">
          ...
          <div class="text-input-bg"><input id="std_mother_tng" name="std_mother_tng" size="30" type="text"></div>
        </div>
	...
	<?php }?>
        ...
        <div class="label-field-pair">
          ...
          <div class="text-input-bg"><input id="std_relgn" name="std_relgn" size="30" type="text"></div>
        </div>
     ...
     <span class="span-sub-heading">CONTACT Details</span>
      <hr class="sub-heading">
        ...
        <div class="label-field-pair">
          ...
          <div class="text-input-bg"><input id="student_address_line1" name="std_add_1" size="30" type="text"></div>
        </div>
        <div class="label-field-pair">
          <label for="student_city">Address Line2</label>
          <div class="text-input-bg"><input id="student_address_line2" name="std_add_2" size="30" type="text"></div>
        </div>
        <div class="label-field-pair">
          <label for="student_city">City</label>
         <div class="text-input-bg"><input id="student_city" name="std_city" size="30" type="text" title="city where you live">
          <label id="err6"></label></div>
        </div>
        <div class="label-field-pair">
          <label for="student_state">State</label>
         <div class="text-input-bg"><input id="student_state" name="std_state" size="30" type="text" title="State where you live"></div>
        </div>
        <div class="label-field-pair">
        <label for="student_pin_code">PIN code</label>
       <div class="text-input-bg"><input id="student_pin_code" name="std_pin" size="30" type="text" title="Pin code of your city"></div>
        </div>
        <div class="label-field-pair">
...
<option value="195">Zimbabwe</option>--></select> </div>
        ...
        <div class="label-field-pair">
          ...
          <div class="text-input-bg"><input id="student_phone1" name="std_phone" size="30" type="text" title=""></div>
        </div>
        <div class="label-field-pair">
          <label for="student_phone2">Mobile</label>
          <div class="text-input-bg"><input id="student_phone2" name="std_mobile" size="30" type="text"></div>
        </div>
        <div class="label-field-pair">
       
          <label for="student_email">Email</label>
          <div class="text-input-bg"><input id="student_email" name="std_email" size="30" type="text" title="">
          </div>
        </div>
