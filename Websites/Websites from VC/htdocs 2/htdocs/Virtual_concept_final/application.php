...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	<title>Virtual Concept ! web and application development</title>
...
<ul id="tiny">
  ...
  <li><a href="services.html" class="active">Our Services</a>
      <!--<ul style="display: none; top: 68px; visibility: visible;">
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Web/ Application Development</h1></div>
        <div class="reght_pagenation"><a href="index.html">Home</a> <i>/</i> <a href="services.html">Services</a> <i>/</i> features</div>
	</div>
</div><!-- end page title -->   
...
<div class="content_fullwidth">
	...
	<div class="pricing-tables-main">
            ...
            <div class="pricing-tables">
                ...
                <div class="cont-list">
                	<ul>
                        ...
                        <li>.NET Framework 2.0/3.5,</li>
                        <li>.Net Compact Framework</li>
                        <li>VB.NET,C#,AJAX,ASP.NET</li>
                        <li>Microsoft Office SharePoint Server,</li>
                        <li>Microsoft VSTS,</li>
                        <li>Dot Net Nuke (DNN)</li>
                        <li class="last">Web Server : IIS 6.0 </li>
                    </ul>
                </div>
            ...
            <div class="pricing-tables-helight">
                ...
                <div class="cont-list">
                	<ul>
                    	<li>PHP, Pear, Dojo, xLibrary, Prototype, AJAX,</li>
                        <li>Java Script, Jquery</li>
                        <li>Joomla, Drupal,  Wordpress, Typo-3,</li>
                        <li>OsCommerce, Zendcart, X-Cart,</li>
                        <li>MySql </li>
                        <li>HTML, HTML5, CSS 3.0</li>
                        <li>Photoshop cs5</li>
                        <li class="last">Dreamweaver cs5</li>
                  </ul>
                </div>
                <div class="ordernow"> </div>
            </div><!-- end section -->
            ...
            <div class="pricing-tables">
                ...
                <div class="cont-list">
                	<ul>
                    	<li>Java, Swings, Applet, TCP IP</li>
                        <li>JSP, Servlet, Struts, Spring, Hibernate</li>
                        <li>Tapestry, EJB, Web Services, JSTL, JSF</li>
                       <!-- <li>/li>
                        <li>5 Free Domain</li>
                        <li>24/7 Unlimited Support</li>-->
                      <li class="last">&nbsp; J2EE, J2ME, Beans, EJB< &nbsp;</li>
                    </ul>
                </div>
                <div class="ordernow"> </div>
            </div><!-- end section -->
            ...
            <div class="pricing-tables">
                ...
                <div class="cont-list">
                	<ul>
                    	<li>SQL, PL/SQL</li>
                        <li>Oracle 8i, 9i and 10g/11g </li>
                        <li>Oracle Application Server 10g Release 2</li>
                        <li>Oracle Forms 6i, Oracle Report6i, Oracle Forms 9i, Oracle Reports 9i, Oracle Forms 10g, Oracle Reports 10g.</li>
                        <li>Oracle Apps Customization, Oracle ERP Customization</li>
                        <li>Oracle Business Intelligence</li>
                        <li class="last">Oracle DBA Services</li>
                    </ul>
                </div>
                <div class="ordernow"> </div>
            </div><!-- end section -->
...
<div class="container">
	...
	<div class="twitter_feed">
             ...
             <p><script src="application_files/ga.js" async type="text/javascript"></script><script src="application_files/widget.js"></script>
                <script>
                new TWTR.Widget({
                  version: 2,
                  type: 'profile',
...
<!-- style switcher -->
<script type="text/javascript" src="application_files/styleswitcher.js"></script>
...
<script type="text/javascript" src="application_files/jquery.js"></script>

 

<!-- main menu -->
<script type="text/javascript" src="application_files/ddsmoothmenu.js"></script>
<script type="text/javascript" src="application_files/jquery-1.js"></script>
<script type="text/javascript" src="application_files/selectnav.js"></script>
...
<!-- main menu -->
<script type="text/javascript" src="application_files/scripts.js"></script>
...
<script type="text/javascript" src="application_files/custom.js"></script>
