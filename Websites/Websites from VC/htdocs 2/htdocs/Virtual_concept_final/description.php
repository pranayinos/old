...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	<title>Virtual Concept ! E commerce</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>E Commerce Solution</h1></div>
        <div class="reght_pagenation"><a href="index.php">Home</a> <i>/</i> <a href="services.php">Services</a> <i>/</i> E Commerce</div>
</div><!-- end page title -->   
...
<div class="content_fullwidth">
    ...
    <div class="big_text1">Virtual Concept Software providing <i>E Commerce Solutions</i> is one of our core expertises</div>
    
    <br>
    
    <img src="images/virtual_concept_img5.png" alt="" class="image_left1">
    ...
    <li>• Magento e Commerce Customization</li>
    ...
    <li>• E Commerce with Content Management System</li>
    <li>• E Commerce in .NET, java and php</li>
    <li>• E Commerce integration with ERP</li>
    </ul></p>
     <p><strong>Virtual Concept Software providing Ecommerce Solutions is one of our core expertises. Choosing right Ecommerce Solution provider shall be an intellectual resolution for your business growth in future.</strong></p>
     <p>Virtual Concept offers various ecommerce solution services like Open Source Ecommerce Integration, E-Commerce with Content Management System, Payment Gateway Integration, Secure Shopping Cart Solutions, Credit Card Processing Integration, X-Cart Integration, OsCommerce Integration and many more.</p>
    </div><!-- end section -->
