...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	<title>Virtual Concept ! Web Development</title>
    ...
    <!-- Favicon --> 
	<link rel="shortcut icon" href="http://virtualconcept.in/favicon.ico">
...
<div class="site_wrapper">
    ...
    <div class="container_full">
    	...
    	<div class="container">
    		...
    		<div id="logo"><a href="index.php" class="site_logo"> </a></div><!-- end logo -->
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Web Development</h1></div>
        <div class="reght_pagenation"><a href="index.php">Home</a> <i>/</i> <a href="services.php">Our Services</a> <i>/</i> Web Development</div>
	</div>
</div><!-- end page title -->   
...
<div class="content_fullwidth">
    ...
    <div class="big_text1">Our complete range of <i>cutting-edge web development services</i> empowers your business to surge ahead of the competition.</div>
    
    <br>
    
    <img src="images/virtual_concept_img2.jpg" alt="" class="image_left1">
    
    <p><strong>Virtual Concept empowers you with its top notch and state of the art website designing, programming and development services backed by ongoing maintenance support driven by latest technological developments.</strong></p>
    <br>
    <p>Our exemplary track record encompasses design and development services pertaining to corporate websites of multi functional and intricate web portals. Virtual Concept has the complete wherewithal to comprehend the technical and business dimensions of websites, putting our dedicated resources to optimal use. Our direct uninterrupted access to professionals around the world, allows us to provide your business with just the right services to thrive in today's business environment.</p>
    <br>
    <p>We create bespoke website solutions to maximise the efficiency and competitive edge for our clients. Our expertise in providing top drawer web development, web design and e-commerce software development services and maintenance of state-of-the-art internet applications pertaining to myriad industry and segments helps us create seamless and trouble free solutions for diverse market verticals.<a href="application.php">Our features</a></p>
    ...
    <div class="clearfix mar_top3"></div>
        	...
        	<div class="box_widget_full">
                ...
                <img src="description_files/site-icon2.png" alt="" class="image_left3">
                <h3>All our creative innovation stands out of the crowd, giving your company an edge over your competitor. </h3>
                <p>Our creative artist uses high graphics computer & systems assuring a time restrained bottom line reducing the web development cost significantly.</p>
            </div>
	
    <div class="clearfix mar_top3"></div>
    
	<div class="big_text1">We have expert team in php-MySql, Wordpress, Joomla, Zen Cart, DotNet, Java and Oracle.</div>
...
<div class="container">
	...
	<div class="twitter_feed">
             ...
             <p><script src="description_files/ga.js" async type="text/javascript"></script><script src="description_files/widget.js"></script>
                <script>
                new TWTR.Widget({
                  version: 2,
                  type: 'profile',
    ...
    <div class="container">
      ...
      <div class="one_fourth last">
        ...
        <div id="flickr_badge_wrapper">
          ...
          <a href="http://www.flickr.com/photos/93382411@N07/8492007572/"><img src="description_files/8492007572_67c355afba_s.jpg" alt="A photo on Flickr" title="5" height="75" width="75"></a> <a href="http://www.flickr.com/photos/93382411@N07/8492003654/"><img src="description_files/8492003654_ce6ed3e18d_s.jpg" alt="A photo on Flickr" title="4" height="75" width="75"></a> <a href="http://www.flickr.com/photos/93382411@N07/8490896907/"><img src="description_files/8490896907_4eea752cdc_s.jpg" alt="A photo on Flickr" title="3" height="75" width="75"></a> <span style="position:absolute;left:-999em;top:-999em;visibility:hidden" class="flickr_badge_beacon"><img src="description_files/p.gif" alt="img" height="0" width="0"></span> </div>
      </div>
      <!-- end flickr -->
    </div>
  </div>
...
<!-- style switcher -->
<script type="text/javascript" src="description_files/styleswitcher.js"></script>
...
<script type="text/javascript" src="description_files/jquery_004.js"></script>

<!-- style switcher -->
<!--<script src="description_files/jquery-1_002.js"></script>
<script src="description_files/styleselector.js"></script>-->

<!-- main menu -->
<script type="text/javascript" src="description_files/ddsmoothmenu.js"></script>
<script type="text/javascript" src="description_files/jquery-1.js"></script>
<script type="text/javascript" src="description_files/selectnav.js"></script>

<!-- jquery jcarousel -->
<script type="text/javascript" src="description_files/jquery_003.js"></script>

<!-- iosSlider plugin -->
<!--<script src="description_files/jquery_002.js"></script>
<script src="description_files/jquery.js"></script>
<script src="description_files/custom_002.js"></script>-->


<!-- progress bar -->
<!--<script src="description_files/progress.js" type="text/javascript" charset="utf-8"></script>-->
...
<!-- main menu -->
<script type="text/javascript" src="description_files/scripts.js"></script>
...
<script type="text/javascript" src="description_files/custom.js"></script>
