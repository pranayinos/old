...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	<title>Virtual Concept ! offshore Software Development</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Offshore Software Development</h1></div>
        <div class="reght_pagenation"><a href="index.php">Home</a> <i>/</i> <a href="services.php">Our Services</a> <i>/</i> Offshore Software Development</div>
	</div>
</div><!-- end page title -->   
...
<div class="content_fullwidth">
    ...
    <div class="big_text1">Offshore software development allows global organizations to procure <i>well featured, cost effective software solutions</i> for their IT requirements from a distant expert software company.</div>
    
    <br>
    
    <img src="images/virtual_concept_img.jpg" alt="" class="image_left1">
    
    <p><strong>Offshore software development service providers enable clients to have world class IT experts and an extension to their development centre without going through the turmoil and hiccups faced in setting up fully functional software development centre and maintaining it for further use.</strong></p>
    <br>
    <p><strong>Virtual Concept</strong> a leading software development company offers a long term reliable partnership that innovates ideas into real world applications with cost effective solutions for client's business requirements. Leveraging the maximum potential from the best in class resources, processes and technologies, <strong>Virtual Concept</strong> aides clients in accelerating time to market, reduce operational cost and empowers them to focus on their core business activities. <strong>Virtual Concept</strong> follows some of the most well conceived and proven development processes to control research and development costs without compromising the quality of the solutions. <a href="application.php">Our features</a></p>
    <br>
...
undoubtable source.  Lorem Ipsum which looks reasonable. The generated 
...
or non-characteristic words etc.</p>-->
    ...
    <!--<div class="clearfix mar_top3"></div>-->
        	...
        	<!--<div class="box_widget_full">
                ...
                <img src="images/site-icon2.png" alt="" class="image_left3">
                <h3>Their exact original form, accompanied by English versions</h3>
                <p>Where popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages treatise on the theory.</p>
            </div>-->
	
    <!--<div class="clearfix mar_top3"></div>-->
    
	<!--<div class="big_text1">Internet tend to repeat predefined chunks as necessary, making this the first true generator uses a dictionary of words.</div>
    -->
    <br>
