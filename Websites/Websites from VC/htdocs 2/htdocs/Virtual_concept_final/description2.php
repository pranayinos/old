...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	<title>Virtual Concept ! Application Development</title>
...
<div class="page_title">
	...
	<div class="container">
		<div class="leaft_title"><h1>Application Development</h1></div>
        <div class="reght_pagenation"><a href="index.php">Home</a> <i>/</i> <a href="services.php">Our Services</a> <i>/</i> Application Development</div>
	</div>
</div><!-- end page title -->   
...
<div class="content_fullwidth">
    ...
    <div class="big_text1">Virtual Concept helps you <i>architect, integrate and manage technology</i> services. Virtual Concept delivers <i>high quality software and customized e-business solutions </i>that reflects the in depth knowledge and understanding of emerging technologies in today's fast growing competitive world</div>
    
    <br>
    
    <img src="images/virtual_concept_img3.jpg" alt="" class="image_left1">
    
    <p><strong>With years of experience in designing, developing and maintaining software products in various verticals, Virtual Concept is now capable of understanding the unique needs of its customers.</strong></p>
    <br>
    <p>We have vast experience in developing new software products for beginners as well as Fortune 500 firms. We have the expertise to develop a new product from ground level. We work with companies who are in different stages - from having just a vision of having detailed product architecture - and transform their work into finished products. </p><br /><p>We can design and build quality software products, whether your software need is a concept, or you have a fully documented design specification. We build products that incorporate all phases of well-designed, manageable software solutions including product definition, planning, design, coding, release management, quality assurance testing, training, deployment and support. Our offshore product development model delivers high quality, reliable and cost-effective Software Product Lifecycle services. <a href="application.php">Our features</a></p>
