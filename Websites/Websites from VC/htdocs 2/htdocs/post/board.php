...
<div class="container">
  <div class="content">
	...
	if ($_FILES["pic"]["error"] > 0)
	   ...
	   {
		   $img=$_FILES["pic"]["name"];
		   $qry="INSERT INTO post VALUES (NULL ,CURRENT_TIMESTAMP, '$name', '$email', '$phone', '$msg', '$img')";
...
//VALUES (NULL , '$name', '$email', '$phone', '$msg')";
	...
	while ($row=mysql_fetch_row($result2))
	{
        ...
        <img src="upload/<?php echo $row['6'] ?>" width="30" height="40" />
        </div>
        <div  style="text-align:left; margin-left:42px">
        <font size="-2">posted by: <?php echo $row[2]; ?>
        </font>
        <font size="-3">(<?php echo $row[3]; ?>)
       	<br />posted at: <?php echo $row[1]; ?>
        </font>
        <br>
        </div>
        ...
        <textarea wrap="hard" cols="28" rows="4"><?php echo $row[5]; ?></textarea>
        </div><br></div>
        <?php
	}?>
    <br>
