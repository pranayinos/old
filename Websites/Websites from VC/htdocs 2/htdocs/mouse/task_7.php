...
{   
    ...
    else
    {
        ...
        else
        {
            ...
            $qr="UPDATE ans SET a7='$_GET[num]' WHERE roll='$roll'";
...
<h1 align="center" style="color: #008000"></br>Your Answer Has Been Submitted Now Go <a href=".\task_8.php">Back</a> and Try Next Question</h1>
<hr />
</div>
...
<div align="center" style="border: black; border-style: groove; height: 200px; width: 1024px; margin-top:3px;  padding-top: 5px;"  >
<h1 align="center" style="color: #008000">Task 7</h1>
<hr  width="80%"/>
<b></b>
