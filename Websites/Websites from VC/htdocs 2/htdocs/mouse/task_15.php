...
{   
    ...
    else
    {
        ...
        else
        {
            ...
            $qr="UPDATE ans SET a15='$_GET[num]' WHERE roll='$roll'";
...
<h1 align="center" style="color: #008000"></br>Your Answer Has Been Submitted Now Go <a href=".\task_1.php">Back</a> and Try Next Question</h1>
<hr />
</div>
