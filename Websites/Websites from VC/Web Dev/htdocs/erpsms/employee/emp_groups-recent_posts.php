...
<link href="css/emp_recent_posts.css" media="screen" rel="stylesheet" type="text/css">
 <!--------- Start head ---------------->
  </head>
  <body>
...
<div id="leftmargin">
  ...
  <div id="replace">
    <div class="red_heading" id="discussion">
      <a href="#">View Recent Activities</a>
    </div>
    <div class="left_sub">
      <div id="comments_heading"><div id="post_recent">Post</div><div id="comment_recent">Comment</div><div id="activity_recent">Activity</div></div>
          ...
          <div class="discussions">
            ...
            <div class="left_discussion_recent">
              ...
              <div id="post_title_recent">
                <a href="#" anchor="comments">s</a>
              </div>
              
                <div class="posted_by">by SUMITH</div>
            ...
            <div class="right_discussion">
              <div class="time_name">
                <div>5 monthsago</div>
                <div id="commenter_name">SUMITH</div>
              </div>
            </div>
          ...
          <div class="discussions">
            ...
            <div class="left_discussion_recent">
              ...
              <div id="post_title_recent">
                <a href="#" anchor="comments">xcx</a>
              </div>
              
                <div class="posted_by">by SUMITH</div>
              
            </div>
            <div class="middle_discussion">2</div>
            <div class="right_discussion">
              <div class="time_name">
                <div>5 monthsago</div>
                <div id="commenter_name">Fedena</div>
              </div>
            </div>
            <div id="horizantal_bar">  </div>
          </div>
          ...
          <div class="discussions">
            ...
            <div class="left_discussion_recent">
              ...
              <div id="post_title_recent">
                <a href="#" anchor="comments">National Seminar</a>
              </div>
              
                <div class="posted_by">by Fedena</div>
              
            </div>
            <div class="middle_discussion">6</div>
            <div class="right_discussion">
              <div class="time_name">
                <div>6 hoursago</div>
                <div id="commenter_name">SUMITH</div>
          ...
          <div class="discussions">
            ...
            <div class="left_discussion_recent">
              ...
              <div id="post_title_recent">
                <a href="#" anchor="comments">EXAM RESULTS</a>
              </div>
