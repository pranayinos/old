...
<div class="text-input-bg"><select id="subject_assignment_department_id" name="subject_assignment[department_id]" onchange="new Ajax.Request(&#39;/employee/employees_list&#39;, {asynchronous:true, evalScripts:true, parameters:&#39;department_id=&#39;+value + &#39;&amp;authenticity_token=&#39; + encodeURIComponent(&#39;HLXw9pp1LGHXQIbHeJV5buYl4nvs9klhjKVT3A7ipVA=&#39;)})"><option value="">Select department</option>
...
<table id="listing" width="100%">
  ...
  <tr class="tr-odd">
    <td class="col-3"><a href="?page=emp_profile">SREEJITH   P.</a></td>
