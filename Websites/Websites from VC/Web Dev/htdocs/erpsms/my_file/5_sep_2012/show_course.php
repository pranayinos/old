<?php
   ...
   $course=$_GET[course];
 	$newsRecordSet = $batch->getdata('*',"batch","batch_course_code='$course'","batch_id DESC", "");// set newsRecordSet to a 
?>
...
<div id="inner-tab-menu">
  <ul>
    <li><a href='?page=new_batch&course=<?=$course?>' id="popnewbatch">New</a> </li>
...
?>                
        ...
        <li class="<?=$col?>">
          <div class="category-name"><a href="?page=batch_student&batchid=<?=$record['id']?>"> <?=$record['batch_course_code']." - ".$record['batch_code']?></a></div>
       <?php /*?>  <div class="category-edit"><a href="?page=edit_batch_course&course=<?=$record['batch_course_code']?>&batch_code=<?=$record['batch_code']?>  ">Edit</a></div><?php */?>
         
          <div class="category-edit"><a href="?page=edit_batch_course&course=<?=$record['batch_course_code']?>&batch_code=<?=$record['batch_code']?>  ">Edit</a></div>
