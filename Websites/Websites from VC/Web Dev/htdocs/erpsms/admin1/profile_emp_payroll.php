  ...
  <ul class="item-list">
    <li class="heading1">Basic Payroll Details</li>
        ...
        <li class="listodd">
          ...
          <div class="item-edit"><span class="currency-type">Rs.</span> </div>
    ...
    <li class="listeven"><div class="item-name">Total :</div><div class="item-edit"><span class="currency-type">Rs.</span> 0</div></li>
    </ul>
