...
if($q!="")
{
$newsRecord = $student->getdata('id,std_adm_no,std_first_name,std_middle_name,std_last_name,std_batch_code',"student","std_first_name like '$q%'","std_first_name ASC", "");
}
	...
	$i++;  
      echo '<li id="subject-1" class="listeven">
        ...
        <div class="opt">
          ...
          <div class="category-edit"><a href="page?edit_subject&subjectid='.$record[subject_id].'" onClick="">Edit</a> </div>
        </div>
      </li>';
	}  
  echo '</ul>';
       ...
       echo' <td class="col-5">'.$i.'</td>
        ...
        <td class="col-1">
		  ...
		  <span class="small"> <a href="#&catid='.$newsRecord[fee_id].'" onclick="">Delete</a></span>
            ...
            <span class="small"> <a href="#">Edit</a></span>
          </div>
        </td>
      </tr>';
	}  
  ...
  <tbody><tr class="tr-head">
   ...
   while( ($record = $newsRecord->getNextRecord()) !== false )
	...
	$i++;  
      ...
      <td class="col-3"> 
  <a href="page?page=fee_collection_date_edit&edit_subject&subjectid='.$record[fee_coll_id].'" onClick="">Edit</a>|
...
//*************************  Dues Student List   **************************************************** 
 ...
 $dues_st_list=$_GET[dues_st_list];

if($dues_st_list!="")
{

$newsRecord = $student->getdata('fee_coll_batch_id',"fee_collection_date","fee_coll_id = '$dues_st_list'","", "");
...
echo '  <table align="center" width="100%" cellpadding="1" cellspacing="1" id="listing">
 ...
 while( ($strecord = $newsRecord->getNextRecord()) !== false )
    ...
    echo'    <tr class="tr-odd">
          ...
          <td class="col-1"><a href="?page=pay_fees_dues_one&id='.$strecord[id].'" class="user_button"> Pay Fees</a></td>
        </tr>';
	}
	echo '</tbody></table>
  <a href="http://demo.fedena.com/finance/fee_defaulters_pdf?batch_id=14&date=8" class="user_button" target="_blank">  PDF Report</a>
';
 }
}
