...
$expencecatSet = $expence->getdata('*',"finance_category","income=1","finance_cat_name ASC", "");
    ...
    if(isset($_POST['addNew_bt'])) // If the submit button was clicked
    {
      // batch entry 
		   ...
		   if($expence->Inserttable($cols,"fin_transaction"))
        {
				...
				header("location:?page=income_create&msg=$msg");			
		}
		else
		{
			$msg="Error :  Entry not done, Please check Values";
			header("location:?page=income_create&error=$msg");
		}		
	}
		?>
