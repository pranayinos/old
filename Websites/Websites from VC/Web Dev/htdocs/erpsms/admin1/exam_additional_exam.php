...
<select id="courses_name" name="courses[name]" onChange="Element.show(&#39;loader&#39;); new Ajax.Request(&#39;/additional_exam/update_batch&#39;, {asynchronous:true, evalScripts:true, onSuccess:function(request){Element.hide(&#39;loader&#39;)}, parameters:&#39;course_name=&#39;+ value + &#39;&amp;authenticity_token=&#39; + encodeURIComponent(&#39;IgTf573VbnZdyF3C2/oQQkEv18QSwa0HJCgS961mcqI=&#39;)})"><option value="">Select a Course</option>
<option value="2">B.A.HISTORY</option>
<option value="3">B.COM COMMERCE</option>
<option value="6">B.Sc CHEMISTRY </option>
<option value="4">B.Sc.MATHMATICS</option>
<option value="5">B.Sc.PHYSICS</option>
<option value="10">Electronics first sem</option>
<option value="9">STANDARD 10</option></select>
</div></div>
