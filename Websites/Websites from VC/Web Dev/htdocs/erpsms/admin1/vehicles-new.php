...
<div id="page-yield">
  ...
  <div id="vehicle_form">
    <form action="#" class="new_vehicle" id="new_vehicle" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="sZFPxPWh30tAllbRpaqOCuodbvivJLocCfe5Ebt0weU="></div>
      

      <div class="label-field-pair">
        <label for="vehicle_no">Vehicle Number<span class="necessary-field">*</span> </label>
        <div class="text-input-bg"><input id="vehicle_vehicle_no" name="vehicle[vehicle_no]" size="30" type="text"></div>
      </div>

      <div class="label-field-pair">
        <label for="vehicle_no">Route<span class="necessary-field">*</span> </label>
        <div class="text-input-bg"><select id="vehicle_main_route_id" name="vehicle[main_route_id]"><option value="">Select main route</option>
<option value="1">abc</option></select></div>
      </div>

      <div class="label-field-pair">
        <label for="vehicle_no">No of seats<span class="necessary-field">*</span> </label>
        <div class="text-input-bg"><input id="vehicle_no_of_seats" name="vehicle[no_of_seats]" size="30" type="text"></div>
      </div>
