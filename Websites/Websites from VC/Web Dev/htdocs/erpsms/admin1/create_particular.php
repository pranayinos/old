...
<?php }}?></select></div>
  ...
  <div class="label-field-pair">
    <div class="label-container"> <label for="finance_fee_particulars_Name">Name</label></div>
   ...
   <div class="label-field-pair">
    ...
    <div class="label-field-pair2" style="margin-bottom:120px;">
      ...
      <div class="opt">
      <input id="createusing" name="createusing" type="radio" value="all" class="MB_focusable">All</div>
     <div class="opt">
    <input id="createusing" name="createusing"  type="radio" value="student" class="MB_focusable">Admission no</div>
        <div class="opt">
     <input id="createusing" name="createusing"  type="radio" value="category" class="MB_focusable">Student Category </div>
      </div>
