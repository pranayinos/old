...
<?php /*?>fee_sub_structure(<?php echo $feecollid ?>,<?php echo $stid ?><?php */?>
  <body onload="fee_sub_structure(document.getElementById('feecollid').value,document.getElementById('txtadmno').value)">
    <!-- header menu --->
...
<div id="page-yield">
  ...
  <input name="txtadmno" id="txtadmno" type="hidden" value="<?php echo $stid?>" />
    <input name="feecollid" id="feecollid" type="hidden" value="<?php echo $feecollid?>" />
  ...
  <form action="?page=student_fee_submission" method="post" onsubmit="return validate()">
    <input name="txtadmno" id="txtadmno1" type="hidden" value="<?php echo $stid?>" />
