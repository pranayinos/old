...
<div id="grading-levels-form">
 ...
 <form action="#" class="new_fa_group" id="new_fa_group" method="post" onsubmit="new Ajax.Request(&#39;/fa_groups&#39;, {asynchronous:true, evalScripts:true, parameters:Form.serialize(this)}); return false;"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="ioHd1weWldQoLIQ81Y+dwML4e/LqwAF6IihFNU0ZREI="></div>
      <div id="form-errors"></div>
      
      <div class="label-field-pair">
        <label for="category_name">Name</label>
       <div class="text-input-bg"><input id="fa_group_name" name="fa_group[name]" size="30" type="text" class="MB_focusable"></div>
      </div>
      <div class="label-field-pair">
        <label for="category_name">Description</label>
       <div class="text-input-bg"><input id="fa_group_desc" name="fa_group[desc]" size="30" type="text" class="MB_focusable"></div>
      </div>
      <div class="label-field-pair">
        <label for="category_name">Max Marks</label>
        <div class="text-input-bg"><input id="fa_group_max_marks" name="fa_group[max_marks]" size="30" type="text" value="100.0" class="MB_focusable"></div>
      </div>
      <div class="label-field-pair">
