...
?><center>
  <table width="850" border="1" cellspacing="2" cellpadding="2" style="border:inset">
    ...
    <tr>
      <th scope="row">&nbsp;Student Middle Name</th>
      <td>&nbsp;<?=$record['std_first_name']?></td>
    </tr>
    <tr>
    ...
    <tr>
      <th scope="row">&nbsp;Course/Batch Names</th>
      <td>&nbsp; <select id="std_batch_code1" name="std_batch_code">
...
<?php }?>
     ...
     <tr>
      ...
      <td>&nbsp;<?=$record['std_blood_grp']?></td>
    </tr>
     <tr>
      <th scope="row">&nbsp;Birth Palace</th>
      <td>&nbsp;<?=$record['std_birth_place'] ?></td>
    </tr>
     <tr>
      <th scope="row">&nbsp;Nationallity</th>
      <td>&nbsp;<?=$record['std_nationality'] ?>
</td>
    </tr>
     <tr>
      <th scope="row">&nbsp;Mother Tongue</th>
      <td>&nbsp;<?=$record['std_last_name']?></td>
    </tr>
	...
	<?php }?>
     ...
     <tr>
      ...
      <td>&nbsp;<?=$record['std_relgn']?></td>
    </tr>
      <tr>
      <th scope="row">&nbsp;Address Line 1</th>
      <td>&nbsp;<?=$record['std_add_1']?></td>
    </tr>
     <tr>
      <th scope="row">&nbsp;Address Line 2</th>
      <td>&nbsp;<?=$record['std_add_2']?></td>
    </tr>
     <tr>
      <th scope="row">&nbsp;City</th>
      <td>&nbsp;<?=$record['std_city']?></td>
    </tr>
     <tr>
      <th scope="row">&nbsp;State</th>
      <td>&nbsp;<?=$record['std_state']?></td>
    </tr>
     <tr>
      <th scope="row">&nbsp;Pin Code</th>
      <td>&nbsp;<?=$record['std_pin']?></td>
    </tr>
      <tr>
