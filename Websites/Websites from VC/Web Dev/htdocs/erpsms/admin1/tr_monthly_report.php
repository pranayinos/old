...
<div id="inner-tab-menu">
  <ul>
    <li><a href="http://demo.fedena.com/finance/transaction_pdf?end_date=2012-07-05&start_date=2012-03-05" target="_blank">PDF Report</a></li>
  </ul>
</div>
<div id="page-yield">
  <div class="box">
  <form action="http://demo.fedena.com/finance/update_monthly_report" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="lCoop3t9/i0YfEvOyx6yVM18cQK+IaV/qhVHk4F/+vk="></div>
...
<div id="page-yield">
  ...
  <br>
    ...
    <script type="text/javascript" src="./update_monthly_report_files/swfobject.js"></script>
          <script type="text/javascript">
AC_FL_RunContent( 'type','application/x-shockwave-flash','data','http://demo.fedena.com/open-flash-chart.swf','width','960','height','500','id','flash_content_qI3sAtNr','style','visibility: visible; ','flashvars','data-file=graph_for_update_monthly_report%3Fstart_date%3D2012-03-05%26end_date%3D2012-07-05','wmode','transparent' ); //end AC code
</script><noscript><object type="application/x-shockwave-flash" data="http://demo.fedena.com/open-flash-chart.swf" width="960" height="500" id="flash_content_qI3sAtNr" style="visibility: visible; "><param name="flashvars" value="data-file=graph_for_update_monthly_report%3Fstart_date%3D2012-03-05%26end_date%3D2012-07-05"><param name="wmode" value="transparent"></object></noscript>
      <script type="text/javascript">
