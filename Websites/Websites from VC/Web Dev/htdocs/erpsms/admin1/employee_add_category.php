...
$status_id=1;
$newsRecordSet = $emp_category->getdata('*',"emp_category","emp_cat_status='$status_id'","emp_cat_id DESC", "50");                     //active category

$id=0;
$newsRecordSet1 = $emp_category->getdata('*',"emp_category","emp_cat_status='$id'","emp_cat_id DESC", "50"); //inactive category
