...
if(isset($_POST['commit'])) // If the submit button was clicked
    {
      ...
      // news entry 
			   $cols['course_name'] =$_POST['course_name'];
			   $cols['cat_id'] =$_POST['cat_id'];
			   $cols['book_issuable'] =$_POST['book_issuable'];
			   $cols['days'] =$_POST['days'];
			  
			   
			   
			   
			   
		if($library_setting->Inserttable($cols,"library_setting"))
        {
				$msg="Library Setting Record Added Succesfully";
...
<!-------------End the code of validation--------------------------------------------->  
  ...
  <h1>Library</h1>
  <h3>Add Library Card setting</h3>
...
<div id="page-yield">
  ...
  <div class="box"><div id="MB_frame" style=""><div id="MB_header"><div id="MB_caption"><b>Add library card Setting</b></div></div><div id="MB_content" style=""><div id="modal-box" style="">
...
<div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="Q82vux645k6qzovSWYhmFGB4wWYAjv9l0xSjcltafEc="></div>
  ...
  <div class="label-field-pair">
    ...
    <div class="input-field">
      <input disabled="disabled" id="course_name" name="course_name" size="30" type="text" value="<?=$n1?>" class="MB_focusable">
      <input id="library_card_setting_course_id" name="course_name" type="hidden" value="<?=$n1?>">
    </div>
  </div>
  <div class="label-field-pair">
...
?>
  ...
  <div class="label-field-pair">
    ...
    <div class="input-field"><input id="library_card_setting_books_issueable" name="book_issuable" size="" type="text"  class="validate[required]  text-input">
    </div>
  </div>
  <div class="label-field-pair">
    <label>Period</label>
    <div class="input-field"><input id="library_card_setting_time_period" name="days" size="30" type="text" value="" class="validate[required]  text-input">Days
    </div>
  </div>
