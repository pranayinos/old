...
xmlhttp.open("GET","?page=student_view_div&paystudent="+str,true);
xmlhttp.send();
}
</script>
...
<div id="content-header">
 <img alt="Student_details_logo" src="../images/student_details/student_details_logo.jpg">
  ...
  <div id="app-back-button">
    <a href="student#" onClick="history.back(); return false;"><img alt="Back" border="0" src="../images/buttons/back.png"></a>
  </div>
</div>

<div id="inner-tab-menu">
  <ul>
    <li><a href="?page=fee_student_view_all">View all</a></li>
...
<div id="page-yield">
  <div id="search_box_bg">
    <form name="search_form" action="" id="frmstudent" name="frmstudent">
