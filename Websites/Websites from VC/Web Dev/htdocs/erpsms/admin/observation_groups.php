...
$newsRecordSet = $co_scholasic_group->getdata('*',"co_scholasic_group","","","");
?>
...
<div id="inner-tab-menu">
  <ul>
    <li><a href='?page=observation_groups_new_popup' id='observation_groups_new_popup' >New</a></li>
  </ul>
</div>
<div id="page-yield">
...
?>
        <tr class="tr-odd">
          <td class="col-1">
            <a href="?page=observation_groups_one&id=<?=$record['co_scholastic_id']?>"><?=$record['name']?></a>
          </td>
          <td class="col-2">
            <a href="?page=observation_groups_one"><?=$record['co_description']?></a>
          </td>
          <td class="col-3">
