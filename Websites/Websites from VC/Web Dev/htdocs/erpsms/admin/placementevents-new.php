...
<link href="css/placement_ new.css" media="screen" rel="stylesheet" type="text/css">
...
<div id="page-yield">
  ...
  <form action="#" class="new_placementevent" id="new_placementevent" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="sZFPxPWh30tAllbRpaqOCuodbvivJLocCfe5Ebt0weU="></div>
    ...
    <div id="new_placementevent_form">
      ...
      <div class="label-field-pair"> <label for="date">Date</label><div class="text-input-bg"> <input class="text-input-bg" id="placementevent[date]" name="placementevent[date]" readonly="readonly" type="text" value="20-07-2012"> <img alt="Calendar" class="calendar_date_select_popup_icon" onClick="new CalendarDateSelect( $(this).previous(), {popup:&#39;force&#39;, year_range:10} );" src="../images/calendar_date_select/calendar.gif" style="border:0px; cursor:pointer;"></div></div>
