...
<img alt="Hostel_small" src="../images/hostels/hostel_small.png">
  <h1>Hostel</h1>
  <h3>View hostel fee defaulters</h3>
  <div id="app-back-button">
    <a href="http://demo.fedena.org/hostel_fee/hostel_fee_defaulters#" onClick="history.back(); return false;"><img alt="Back" border="0" src="../images/buttons/back.png"></a>
  </div>
</div>
...
<div id="page-yield">
  <div class="box">
    ...
    <div class="label-field-pair"><label>select a class</label>
      <div class="text-input-bg"> <select id="fee_submission_batch_id" name="fee_submission[batch_id]" onChange="new Ajax.Request(&#39;/hostel_fee/update_fee_collection_defaulters_dates&#39;, {asynchronous:true, evalScripts:true, parameters:&#39;batch_id=&#39;+value + &#39;&amp;authenticity_token=&#39; + encodeURIComponent(&#39;kCWJmowIJe0ctFJ3Do7/FinMssy2Iox1bXH7//ekfPM=&#39;)})">
...
<?php }?>
    ...
    <div class="label-field-pair"><label>Select fee collection date</label>
      ...
      <div class="text-input-bg">
        <div id="hostel_fee_collection_dates"><select id="id_id" name="id[id]" onChange="new Ajax.Request(&#39;/hostel_fee/hostel_fee_collection_defaulters_details&#39;, {asynchronous:true, evalScripts:true, parameters:&#39;collection_id=&#39;+value + &#39;&amp;authenticity_token=&#39; + encodeURIComponent(&#39;kCWJmowIJe0ctFJ3Do7/FinMssy2Iox1bXH7//ekfPM=&#39;)})">
