...
<option value="62">3 - 2012-2013</option></select>
    ...
    <div id="exam-list"> <div class="label-field-pair">
   <label for="student_course">Select Exam:
<img align="absmiddle" alt="Loader" border="0" id="loader" src="../images/loader.gif" style="display: none;">
   </label>
   <div class="text-input-bg">
  <select id="batch_id" name="batch[id]" onchange="Element.show(&#39;loader&#39;); new Ajax.Request(&#39;/online_exam/update_student_list&#39;, {asynchronous:true, evalScripts:true, onSuccess:function(request){Element.hide(&#39;loader&#39;)}, parameters:&#39;id=&#39;+value + &#39;&amp;authenticity_token=&#39; + encodeURIComponent(&#39;pETlawbN3qM7axWlhooH9wT/l1nns3mrCea9udiE/gE=&#39;)})"><option value="">Select Exam</option>
</select>
</div></div></div>
