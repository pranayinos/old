...
<div id="content-header">
  ...
  <h1>Exams</h1>
  <h3>Student Ranking per Course</h3>
    ...
    <form action="#" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="Fx0ICRRbO4rrhCDJM/624/7sUzivQNmpkyG0E+3MKOA="></div>
      <div class="label-field-pair">
        ...
        <div class="text-input-bg">
          <select id="course_rank_course_id" name="course_rank[course_id]" onChange="new Ajax.Request(&#39;/exam/batch_groups&#39;, {asynchronous:true, evalScripts:true, parameters:&#39;course_id=&#39;+value + &#39;&amp;authenticity_token=&#39; + encodeURIComponent(&#39;Fx0ICRRbO4rrhCDJM/624/7sUzivQNmpkyG0E+3MKOA=&#39;)})"><option value="">Select a course</option>
