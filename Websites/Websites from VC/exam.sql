...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2013 at 01:34 PM
...
(45, 8, 1, 'jbhh', 'ghgg', 'hg', 'hgh', 'gh', 1, 1);
...
(1, 'new user', 'user', 'User', 'User Chowk', 'Usaribag', 2323233, 'user@domain.com');
