...
if(isset($submit))
{
	$qry_login="select user_id from mst_user where login='$loginid' and pass='$pass'";
	$rs=mysql_query($qry_login,$cn);
	...
	else
	{
		...
		$_SESSION['user_id']=mysql_result($rs,0);
	}
}
...
<table width="98%" border="0">
  <tr>
    ...
    <td width="22%" bgcolor="#CC3333"><div align="center" class="style1">User Login </div></td>
  </tr>
  <tr>
