...
$(function() {
  ...
  // Simulate some progress
  $('#progress_bar2 .ui-progress').animateProgress(97, function() {
    $(this).animateProgress(97, function() {
      setTimeout(function() {
        $('#progress_bar2 .ui-progress').animateProgress(97, function() {
          $('#main_content').slideDown();
          $('#fork_me').fadeIn();
...
$(function() {
  ...
  // Simulate some progress
  $('#progress_bar3 .ui-progress').animateProgress(94, function() {
    $(this).animateProgress(94, function() {
      setTimeout(function() {
        $('#progress_bar3 .ui-progress').animateProgress(94, function() {
          $('#main_content').slideDown();
          $('#fork_me').fadeIn();
...
$(function() {
  ...
  // Simulate some progress
  $('#progress_bar5 .ui-progress').animateProgress(99, function() {
    $(this).animateProgress(99, function() {
      setTimeout(function() {
        $('#progress_bar5 .ui-progress').animateProgress(99, function() {
          $('#main_content').slideDown();
...
$(function() {
  ...
  // Simulate some progress
  $('#progress_bar6 .ui-progress').animateProgress(99, function() {
    $(this).animateProgress(99, function() {
      setTimeout(function() {
        $('#progress_bar6 .ui-progress').animateProgress(99, function() {
          $('#main_content').slideDown();
