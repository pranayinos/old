                ...
                <div id="menu" class="menu"> 
                    ...
                    <ul id="tiny">
                      ...
                      <!--  
                        ...
                        <li><a href="contact.php" class="active">Contact Us</a>
...
<div class="page_title">
	...
	<div class="container">
        ...
        <div class="reght_pagenation"><a href="index.php">Home</a> <i>/</i> Contact Us</div>
	</div>
</div><!-- end page title -->   
...
<script type="text/javascript" src="contact_files/custom_002.js"></script>
