cascading_vertical_menu.class
Scott Mattocks
mttcks@hotmail.com

This class will create a vertical cascading menu in HTML.  The
...
Each choice may have sub-choices which will appear to the right
of the parent-choice.  A menu may have as many choices as desired. 
The width of each choice (and sub-choice) will be the width of the 
menu  Each choice (and sub-choice) can have as many children as 
desired.  The main menu and each choice object can be given its own
css class to control the style and appearence.  

How to use cascading_vertical_menu.class:
1  Create a cascading_vertical_menu object...
   You need: the top and left coordinates (main menu is static)
             the height you want the menu to be
             the total width menu
             the name of the css class for the main menu
   $menu = new cascading_verticle_menu($top, $left, $height, $width, $css);
...
mttcks@hotmail.com with cascading_vertical_menu in the subject.
Any hints for optimizing and cleaning up this class are gladly
