...
{   
    ...
    else
    {
        ...
        else
        {
            ...
            $qr="UPDATE ans SET a12='$_GET[num]' WHERE roll='$roll'";
    ...
    else {?> <script language="JavaScript" type="text/javascript"> alert('You Are Not Signed in Please Sign in and try again') </script> <?php /*header('location:home.php');*/}
...
<h1 align="center" style="color: #008000"></br>Your Answer Has Been Submitted Now Go <a href="task_13.php">Back</a> and Try Next Question</h1>
<hr />
</div>
...
<div align="center" style="border: black; border-style: groove; height: 200px; width: 1024px; margin-top:3px;  padding-top: 5px;"  >
<h1 align="center" style="color: #008000">Task 12</h1>
<hr  width="80%"/>
<b></b>
What combination of keys can be used to delete one word to left?
