...
<head>
	...
	<title>uppAuction - Won Bids </title>
...
<div style="background-repeat: no-repeat; height: 45px; width:1024; background-image:url(images/menu.jpg); background-position:center; color: #FFF;">
  <table width="1024" height="44" border="0" align="center">
    ...
    <tr>
      ...
      <td width="171" align="center" style="background-color: #00A652;"> Won Bids</td>
      <td width="157" align="center"><a href="change_password bidder.php">Settings</a></td>
      <td width="159" align="center"> <a href="index.php"><?php $user=$_COOKIE["user"];
...
<tr>
  ...
  <th width="110" align="center" valign="middle">Winning Bid</th>
  </tr>
<?php
include_once "db.php"; 
...
$query = "SELECT Sr_No, Product_name, Description, stock, Base_price, highest_bid FROM itemsclosed WHERE highest_bidder='$user' ";
